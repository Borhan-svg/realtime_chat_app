                  ...
                  : Column(
                    ...
                    children: [
                      const Padding(
                        ...
                        child: Text('Conversations you are involved in.' , style: TextStyle(fontWeight: FontWeight.w500),),
                      ),
                      Expanded(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                leading: OnlineAvatar(
                                  ...
                                  isOnline: controller.activeIDS.contains(chat.userId),
                                ),
                        
                                title: Text(chat.userFirstName , style: const TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15
                                ),),
                                subtitle: Text(chat.lastMessage, style: const TextStyle(
                                  fontSize: 12
                                ),),
                                onTap: () {
                  ...
                  : Center(
                      child: Column(
                        ...
                        children: [
                          const Padding(
                        padding: EdgeInsets.only(left: 10 , top: 20 , bottom: 10),
                        child: Text('Active users' , style: TextStyle(fontWeight: FontWeight.w500),),
                      ),
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return ListTile(
                                  ...
                                  title: Text(user.userFirstName , style: const TextStyle(fontWeight: FontWeight.bold),),
                                  leading: OnlineAvatar(imageUrl: 'assets/image/profilee.png', isOnline: true),
